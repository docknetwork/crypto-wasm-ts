...
describe('CredentialBuilder Schema', () => {
  ...
  it('flattening', () => {
    ...
    expect(cs5.flatten()).toEqual([
      ...
      [
        ...
        { type: 'string' },
        { type: 'string' },
        { decimalPlaces: 3, minimum: -90, type: 'number' },
        { decimalPlaces: 3, minimum: -180, type: 'number' },
        { type: 'string' },
        { type: 'string' },
        { type: 'string' },
        { type: 'string' },
  ...
  it('subject as an array', () => {
    ...
    expect(cs6.flatten()).toEqual([
      ...
      [
        { type: 'string' },
        { type: 'number', decimalPlaces: 3, minimum: -90 },
        { type: 'number', decimalPlaces: 3, minimum: -180 },
        { type: 'string' },
        { type: 'string' },
        { type: 'number', decimalPlaces: 3, minimum: -90 },
        { type: 'number', decimalPlaces: 3, minimum: -180 },
