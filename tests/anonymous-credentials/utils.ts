import {
  STATUS_STR,
  SUBJECT_STR,
  CredentialSchema, IJsonSchema, SCHEMA_TYPE_STR, CredentialBuilder
} from '../../src';
...
export function getExampleBuilder(num): CredentialBuilder {
  ...
  switch (num) {
    ...
    case 2:
      builder.schema = credSchema;
      builder.subject = { fname: 'John', lname: 'Smith', city: 'NY', education: {university: 'Example', major: 'Nothing'}, someArr: ['exampleItem', 'exampleItem2', 4, 'exampleItem3'] };
      break;
    case 3:
      builder.schema = credSchema;
      builder.subject = { fname: 'John', lname: 'Smith', city: 'NY', education: {university: 'Example', major: 'Nothing', location: {name: 'xyz', lat: 2.12, long: 23.109}} };
      break;
    case 4:
    ...
    case 6:
      builder.schema = credSchema1;
      builder.subject = { fname: 'John', lname: 'Smith', city: 'NY', universities: [{university: 'Example', major: 'Nothing', location: {name: 'xyz', lat: 2.12, long: 23.109}}, {university: 'Example1', major: 'Nothing again', location: {name: 'abc', lat: 50, long: -40.6}}] };
      break;
    case 7:
      builder.schema = credSchema1;
      builder.subject = { fname: 'John', lname: 'Smith', city: 'NY', universities: [{university: 'Example', major: 'Nothing', location: {name: 'xyz', lat: 2.12, long: 23.109}}, ['foo', 'bar', {foo: 'bar', bar: 'baz'}], 'Something else'] };
      break;
    case 8:
      builder.schema = credSchema1;
      builder.subject = { city: 'NY', education: {major: 'Nothing', location: {name: 'xyz', lat: 2.12, long: 23.109}} };
      break;
    case 9:
      builder.schema = credSchema1;
