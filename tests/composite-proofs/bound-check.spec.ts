...
describe('Bound check of signed messages', () => {
  ...
  it('use bound check for proving earlier than or later than with timestamps', () => {
    ...
    attributes.push(SignatureG1.encodePositiveNumberForSigning(earliestIssuance + 100000)); // Issuance date as no. of milliseconds since epoch
    attributes.push(SignatureG1.encodePositiveNumberForSigning(now + 2000000)); // Expiration date as no. of milliseconds since epoch
