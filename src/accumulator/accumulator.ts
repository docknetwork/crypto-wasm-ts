...
import {
    ...
    accumulatorDeriveMembershipProvingKeyFromNonMembershipKey, generateRandomFieldElement,
...
export abstract class Accumulator {
     ...
     */
    abstract addRemoveBatches(additions: Uint8Array[], removals: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState): void;
     ...
     */
    abstract membershipWitness(element: Uint8Array, secretKey?: Uint8Array, state?: IAccumulatorState): Promise<MembershipWitness>;
     ...
     */
    abstract membershipWitnessesForBatch(elements: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState): Promise<MembershipWitness[]>;
     ...
     * @param params
     */
    abstract verifyMembershipWitness(member: Uint8Array, witness: MembershipWitness, pk: Uint8Array, params?: AccumulatorParams): boolean;
...
export class PositiveAccumulator extends Accumulator {
     ...
     * @param state
     */
    async addRemoveBatches(additions: Uint8Array[], removals: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState) {
     ...
     */
    async membershipWitness(member: Uint8Array, secretKey?: Uint8Array, state?: IAccumulatorState): Promise<MembershipWitness> {
     ...
     */
    async membershipWitnessesForBatch(members: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState): Promise<MembershipWitness[]> {
     ...
     */
    verifyMembershipWitness(member: Uint8Array, witness: MembershipWitness, publicKey: Uint8Array, params?: AccumulatorParams): boolean {
    ...
    toJSON(): string {
        return JSON.stringify({
            value: Array.from(this.value), sk: this.secretKey, params: this.params
        })
    }
...
export class UniversalAccumulator extends Accumulator {
     ...
     */
    static async initialize(maxSize: number, params: AccumulatorParams, secretKey: Uint8Array, initialElementsStore?: IInitialElementsStore, batchSize = 100): Promise<UniversalAccumulator> {
     ...
     * @param secretKey
     */
    static initializeGivenInitialElementsProduct(maxSize: number, initialElementsProduct: Uint8Array, params: AccumulatorParams, secretKey?: Uint8Array): UniversalAccumulator {
     ...
     */
    async add(element: Uint8Array, secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore) {
     ...
     * @param initialElementsStore - if provided, check that the element is not part of the initial elements, throws error if it is.
     */
    async remove(element: Uint8Array, secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore) {
    ...
    async addBatch(elements: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore) {
    ...
    async removeBatch(elements: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore) {
    ...
    async addRemoveBatches(additions: Uint8Array[], removals: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore) {
    ...
    async membershipWitness(member: Uint8Array, secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<MembershipWitness> {
    ...
    async membershipWitnessesForBatch(members: Uint8Array[], secretKey?: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<MembershipWitness[]> {
        await this.checkElementBatchAcceptable(members, initialElementsStore);
        await this.ensurePresenceOfBatch(members, state);
        const sk = this.getSecretKey(secretKey);
        return universalAccumulatorMembershipWitnessesForBatch(this.value, members, sk).map(m => new MembershipWitness(m));
    }
     ...
     * @param batchSize - Breaks down this large computation in batches of size `batchSize`.
     */
    async nonMembershipWitness(nonMember: Uint8Array, state: IUniversalAccumulatorState, secretKey?: Uint8Array, params?: AccumulatorParams, initialElementsStore?: IInitialElementsStore, batchSize = 100): Promise<NonMembershipWitness> {
     ...
     * @param initialElementsStore
     */
    async nonMembershipWitnessGivenD(nonMember: Uint8Array, d: Uint8Array, secretKey?: Uint8Array, params?: AccumulatorParams, state?: IUniversalAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<NonMembershipWitness> {
        await this.checkElementAcceptable(nonMember, initialElementsStore);
        await this.ensureAbsence(nonMember, state);
        const sk = this.getSecretKey(secretKey);
        const params_ = this.getParams(params);
     ...
     * @param batchSize - Breaks down this large computation in batches of size `batchSize`.
     */
    async nonMembershipWitnessesForBatch(nonMembers: Uint8Array[], state: IUniversalAccumulatorState, secretKey?: Uint8Array, params?: AccumulatorParams, initialElementsStore?: IInitialElementsStore, batchSize = 100): Promise<NonMembershipWitness[]> {
        ...
        return universalAccumulatorNonMembershipWitnessesForBatch(this.value, ds, nonMembers, sk, params_).map(m => new NonMembershipWitness(m))
    }
     ...
     * @param initialElementsStore
     */
    async nonMembershipWitnessesForBatchGivenD(nonMembers: Uint8Array[], d: Uint8Array[], secretKey?: Uint8Array, params?: AccumulatorParams, state?: IUniversalAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<NonMembershipWitness[]> {
        await this.checkElementBatchAcceptable(nonMembers, initialElementsStore);
        await this.ensureAbsenceOfBatch(nonMembers, state);
        const sk = this.getSecretKey(secretKey);
        const params_ = this.getParams(params);
        return universalAccumulatorNonMembershipWitnessesForBatch(this.value, d, nonMembers, sk, params_).map(m => new NonMembershipWitness(m));
    }

    verifyMembershipWitness(member: Uint8Array, witness: MembershipWitness, pk: Uint8Array, params?: AccumulatorParams): boolean {
        const params_ = this.getParams(params);
        return universalAccumulatorVerifyMembership(this.value.V, member, witness.value, pk, params_);
    }

    verifyNonMembershipWitness(nonMember: Uint8Array, witness: NonMembershipWitness, pk: Uint8Array, params?: AccumulatorParams): boolean {
        const params_ = this.getParams(params);
     ...
     * @protected
     */
    protected async checkBeforeAdd(element: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<void> {
     ...
     * @protected
     */
    protected async checkBeforeRemove(element: Uint8Array, state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<void> {
        await this.checkElementAcceptable(element, initialElementsStore);
     ...
     * @protected
     */
    protected async checkBeforeAddBatch(elements: Uint8Array[], state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<void> {
        if (state !== undefined) {
            for (const e of elements) {
     ...
     * @protected
     */
    protected async checkBeforeRemoveBatch(elements: Uint8Array[], state?: IAccumulatorState, initialElementsStore?: IInitialElementsStore): Promise<void> {
        if (state !== undefined) {
            for (const e of elements) {
                await this.checkElementAcceptable(e, initialElementsStore);
    ...
    toJSON(): string {
        return JSON.stringify({
            value: {f_V: Array.from(this.value.f_V), V: Array.from(this.value.V)}, sk: this.secretKey, params: this.params
        })
    }
