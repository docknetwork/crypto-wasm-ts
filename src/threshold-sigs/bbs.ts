...
import {
  thresholdBbsPhase1ProcessCommitments, thresholdBbsAggregateSignatureShares, thresholdBbsCreateSignatureShare,
  thresholdBbsPhase1Finish,
  thresholdBbsPhase1GetSharesForOther,
  thresholdBbsPhase1GetSharesForOthers,
  thresholdBbsPhase1ProcessShares, thresholdBbsPhase2Finish,
...
export class ThresholdBbsSigner extends ThresholdSigner {
  ...
  createSigShare(messages: Uint8Array[], indexInOutput: number, params: BBSSignatureParams, encodeMessages: boolean): ThresholdBbsSignatureShare {
    this.ensureRound2Finished();
    const sigShare = thresholdBbsCreateSignatureShare(messages, indexInOutput, this.round1Output as Uint8Array, this.round2Output as Uint8Array, params.value, encodeMessages);
