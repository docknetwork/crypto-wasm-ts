...
export class Statement {
    ...
    static poKBBSSignature(sigParams: SignatureParamsG1, publicKey: Uint8Array, revealedMessages: Map<number, Uint8Array>, encodeMessages: boolean): Uint8Array {
        return generatePoKBBSSignatureStatement(sigParams.value, publicKey, revealedMessages, encodeMessages);
    }

    static accumulatorMembership(params: AccumulatorParams, publicKey: Uint8Array, provingKey: Uint8Array, accumulated: Uint8Array): Uint8Array {
        return generateAccumulatorMembershipStatement(params, publicKey, provingKey, accumulated);
    }

    static accumulatorNonMembership(params: AccumulatorParams, publicKey: Uint8Array, provingKey: Uint8Array, accumulated: Uint8Array): Uint8Array {
