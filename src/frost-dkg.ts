...
import {
  ...
  frostKeygenG2ThresholdPubkeyFromPubkeys, generateKeyBaseFromGivenG2Point
...
/**
 * Participant in the FROST DKG. Each participant has a unique integer id > 0 and ids form a contiguous set, i.e. no gaps
 */
export abstract class Participant {
  ...
  protected abstract startRound1Func(): (participantId: number, threshold: number, total: number, protocolId: Uint8Array, pkBase: Uint8Array) => [Uint8Array, Uint8Array];

  protected abstract processRound1MsgFunc(): (roundState: Uint8Array, msg: Uint8Array, protocolId: Uint8Array, pkBase: Uint8Array) => Uint8Array;

  protected abstract finishRound1Func(): (roundState: Uint8Array) => [Uint8Array, Uint8Array[]];

  protected abstract processRound2MsgFunc(): (roundState: Uint8Array, senderId: number, share: Uint8Array, pkBase: Uint8Array) => Uint8Array;

  protected abstract finishRound2Func(): (roundState: Uint8Array, pkBase: Uint8Array) => [Uint8Array, Uint8Array, Uint8Array];

  protected abstract thresholdPublicKeyFromPublicKeysFunc(): (pubkeys: [number, Uint8Array][], threshold: number) => Uint8Array;
}

export class ParticipantG1 extends Participant {
  protected startRound1Func(): (participantId: number, threshold: number, total: number, protocolId: Uint8Array, pkBase: Uint8Array) => [Uint8Array, Uint8Array] {
    return frostKeygenG1StartRound1;
  }

  protected processRound1MsgFunc(): (roundState: Uint8Array, msg: Uint8Array, protocolId: Uint8Array, pkBase: Uint8Array) => Uint8Array {
  ...
  protected processRound2MsgFunc(): (roundState: Uint8Array, senderId: number, share: Uint8Array, pkBase: Uint8Array) => Uint8Array {
